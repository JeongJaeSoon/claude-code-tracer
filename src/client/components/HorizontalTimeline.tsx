  ...
  return (
    <div className="horizontal-timeline" ref={containerRef}>
          ...
          <div key={lane.id} className="lane">
            <div className="lane-label">
              <div
                ...
                style={{ background: lane.id === "main" ? LANE_COLORS.main : LANE_COLORS.subagent }}
              ></div>
            ...
            <div className="lane-track">
              ...
              {lane.turns.map((turn, turnIdx) => {
                ...
                const width = ((turn.endTime - turn.startTime) / totalDuration) * 100;
                ...
                return (
                  ...
                  >
                    ...
                    {toolSteps.length > 0 && (
                      <span className="turn-tools">{toolSteps.length} tools</span>
                    )}
                  </div>
                );
              })}
      ...
      <div className="timeline-legend">
        ...
        {Object.entries(TOOL_COLORS).slice(0, 6).map(([name, color]) => (
...
function calculateInterval(totalMs: number): number {
  ...
  const niceIntervals = [
    ...
    60000, 120000, 300000, 600000, 900000, // minutes
    1800000, 3600000, // half hour, hour
  ];
